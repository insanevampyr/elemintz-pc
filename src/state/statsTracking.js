...
export function normalizeProfileModeStats(profile) {
  ...
  return {
    ...
    totalLoggedInPlayTimeMs: safeNonNegativeInt(profile.totalLoggedInPlayTimeMs),
    ...
    gauntletBestStreak: safeNonNegativeInt(profile.gauntletBestStreak),
    gauntletRuns: safeNonNegativeInt(profile.gauntletRuns),
    ...
    vampyrLeeLongestMatchBackfillApplied: Boolean(profile.vampyrLeeLongestMatchBackfillApplied),

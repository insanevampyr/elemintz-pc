...
function buildElemintzBridge(ipcRenderer, { appVersion = "unknown" } = {}) {
  return {
    ...
    state: {
      ...
      updateProfileShowcaseSlot: (payload) => ipcRenderer.invoke("state:updateProfileShowcaseSlot", payload),
      claimCollectionAlbumReward: (payload) => ipcRenderer.invoke("state:claimCollectionAlbumReward", payload),
    ...
    multiplayer: {
      ...
      getStore: (payload) => ipcRenderer.invoke("multiplayer:getStore", payload),
      ...
      openEventChestEntitlement: (entitlementId) =>
        ipcRenderer.invoke("multiplayer:openEventChestEntitlement", { entitlementId }),
      openEventChest: (payload) =>
        ipcRenderer.invoke("multiplayer:openEventChest", payload),
      ...
      updateProfileShowcaseSlot: (payload) => ipcRenderer.invoke("multiplayer:updateProfileShowcaseSlot", payload),
      claimCollectionAlbumReward: (payload) => ipcRenderer.invoke("multiplayer:claimCollectionAlbumReward", payload),
      ...
      getEmailVerificationStatus: (payload) => ipcRenderer.invoke("multiplayer:getEmailVerificationStatus", payload),
      ...
      getReferralDashboard: (payload) => ipcRenderer.invoke("multiplayer:getReferralDashboard", payload),
      claimReferralReward: (payload) => ipcRenderer.invoke("multiplayer:claimReferralReward", payload),

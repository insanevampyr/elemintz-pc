...
function buildElemintzBridge(ipcRendererRef, { appVersion = "unknown" } = {}) {
  return {
    ...
    state: {
      ...
      addProfilePlayTime: (payload) => ipcRendererRef.invoke("state:addProfilePlayTime", payload),
    ...
    multiplayer: {
      ...
      openEventChest: (payload) =>
        ipcRendererRef.invoke("multiplayer:openEventChest", payload),
      ...
      addProfilePlayTime: (payload) => ipcRendererRef.invoke("multiplayer:addProfilePlayTime", payload),
      ...
      getReferralDashboard: (payload) =>
        ipcRendererRef.invoke("multiplayer:getReferralDashboard", payload),
      claimReferralReward: (payload) =>
        ipcRendererRef.invoke("multiplayer:claimReferralReward", payload),
